...
var nduskTime = times.sunset.getHours() + ':' + times.sunset.getMinutes();
  ...
  document.getElementById('fleet').innerHTML =  "<b style='font-size: 10px;'>moment</b></br><span style='text-align:center; font-size: 18px;'>" + fleetingMoment + "</span></br></br>";
...
<div style="position: relative; margin: 0 auto;color: #ccc; background: #000; border-radius: 0 0 10px  10px ; padding: 10px; text-align: center; font-family: Sans-Serif; font-size: 26px; letter-spacing: 3px; width: 200px; ">slice</div>
...
<div id="fleet" style="background: #222; margin: 5px auto; padding: 15px; text-align: center; border-radius: 50%; height: 40px; width: 40px; border: 2px solid #333; font-size: 14px; font-style:italic; color: #777;"></div>
...
<div id="birthYear" style="padding: 10px; font-size: 24px; font-weight: bold; padding-bottom: 30px;"><?php include 'birthyear.php';?>
</div>
</div>
