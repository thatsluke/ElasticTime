...
<meta property="og:title" content="Try the Personal Elastic Time clock!" />
...
var nduskTime = times.sunset.getHours() + ':' + times.sunset.getMinutes();
  ...
  if (currentMs >= dawn && currentMs <= dusk) {
    ...
    var fleetingMoment = currentMoment.toFixed(25)
  ...
  document.getElementById('detail').innerHTML =  "( ! ) this exact moment is fleeting " + fleetingMoment + " ( ! )";
...
<div id="yearday" style="padding: 10px; font-size: 36px; font-weight: bold;">day <?php echo date("z") + 1; ?></div>
<div id="cycle" style="padding: 10px; font-size: 24px; font-weight: bold;">cycle <?php echo date("W"); ?></div>
<div id="detail" style="color: #777;padding-top: 60px; padding-bottom: 100px;margin-bottom: 10px;font-size: 12px;letter-spacing: 1px;"></div>
</div>
