...
<title>Elastic Time - A natural rhythm for your sync</title>
<meta property="og:url" content="https://elastictime.me" />
<meta property="og:type" content="app" />
<meta property="og:title" content="Try the Personal Elastic Time clock! - 10 slices Day / 10 slices Night" />
...
var nNadirTime = times.nadir.getHours() + ':' + times.nadir.getMinutes(); 
  ...
  document.getElementById('day').innerHTML =  (day ? "☀ Day Light" : "<span style='color:#555'>☽ Dark Night</span>");
  document.getElementById('slice').innerHTML =  "slice " + sliceAdj + " of " + slices + " / ";
  document.getElementById('action').innerHTML =  "action " + actionAdj + " of 10";
...
<div id="slice" style="text-align: center; font-family: Sans-Serif; font-size: 18px; font-weight:bold;color: #ccc;display: inline-block;">&nbsp;</div>
<div id="action" style="padding-bottom: 10px; padding-top: 20px; font-size: 18px; font-weight: bold;display: inline-block;">&nbsp;</div>
